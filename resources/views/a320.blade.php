...
<!--================ Start Hero Section =================-->
<section class="hero-section airbus-hero">
    <div class="container">
                ...
                <div class="hero-content">
                    <div class="country-header">
                        <div class="country-flag">
                            <img src="{{ asset('img/header.png') }}" alt="Airbus" class="flag-img">
                        </div>
                        <div class="country-name">Airbus A320</div>
                    </div>
                ...
                <div class="hero-image-grid">
                    <div class="row">
                        ...
                        <div class="image-card">
                            <img src="{{ asset('img/a320-cockpit.webp') }}" alt="A320 Cockpit">
                            <div class="image-hover-description">
                                <span>Modern Glass Cockpit with advanced avionics and flight management systems</span>
                            </div>
                        </div>
                    </div>
                        <div class="col-6">
                            <div class="image-card">
                                <img src="{{ asset('img/a320-simulator.jpg') }}" alt="A320 Simulator">
                        ...
                        <div class="col-12 mt-3">
                            <div class="image-card ">
                                <img src="{{ asset('img/a320-aircraft.jpg') }}" alt="A320 Aircraft">
                                <div class="image-overlay">
                                    <div class="overlay-content">
                                        <i class="lnr lnr-airplane"></i>
        ...
        <div class="row mb-5">
            <div class="col-lg-12">
                <div class="main_title text-center">
                    <h2 class="mb-3">A320 Type Rating Training Process</h2>
                    <p>Complete DGCA-compliant training pathway to become A320 certified</p>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-5">
            <div class="col-lg-12">
                <div class="quick-facts">
                    <h4>A320 Type Rating Quick Facts</h4>
                    <ul class="unordered-list">
                        ...
                        <li><strong>Base Training:</strong> 6 take-offs & landings in actual A320</li>
                        <li><strong>Cockpit Type:</strong> Glass cockpit with sidestick controls</li>
                        <li><strong>Automation Level:</strong> High - Fly-by-wire system</li>
                        <li><strong>Market Demand:</strong> Very high (IndiGo, Air India, Vistara)</li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="advantages-section">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="main_title text-center">
                    <h2 class="mb-3">Airbus A320 Aircraft Specifications</h2>
                    <p>Modern fly-by-wire aircraft with advanced automation systems</p>
                </div>
            </div>
        </div>
        ...
        <div class="advantages-grid">
            <div class="advantage-card">
                ...
                <div class="advantage-content">
                    <h4 class="advantage-title">Glass Cockpit Design</h4>
                    <p class="mt-2">Advanced digital cockpit with sidestick controllers and fly-by-wire technology</p>
                </div>
            </div>
            ...
            <div class="advantage-card">
                ...
                <div class="advantage-content">
                    <h4 class="advantage-title">ECAM Systems</h4>
                    <p class="mt-2">Electronic Centralized Aircraft Monitor for comprehensive system monitoring</p>
                </div>
            </div>
            ...
            <div class="advantage-card">
                ...
                <div class="advantage-content">
                    <h4 class="advantage-title">Flight Envelope Protection</h4>
                    <p class="mt-2">Automated protection systems prevent aircraft from exceeding operational limits</p>
                </div>
            </div>
            ...
            <div class="advantage-card">
                ...
                <div class="advantage-content">
                    <h4 class="advantage-title">High Automation</h4>
                    <p class="mt-2">Extensive automation reduces pilot workload and enhances safety</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h2 class="text-white mb-4">Ready to Start Your A320 Type Rating?</h2>
                <p class="text-white mb-4">Begin your journey to becoming an Airbus A320 First Officer with our comprehensive DGCA-approved training program</p>
                <a href="{{ route('contact') }}" class="genric-btn primary-border circle arrow text-white">
                    Start A320 Training <span class="lnr lnr-arrow-right"></span>
                </a>
            </div>
        </div>
    </div>
...
/* ===== A320 Specific Styles ===== */
.page-header-section {
    background: linear-gradient(135deg, var(--primary-color) 0%, var(--secondary-color) 100%) !important;
}

/* A320 specific color variations */
.a320-accent {
    color: var(--primary-color);
}
...
/* Custom A320 animations */
@keyframes a320-float {
    0%, 100% { transform: translateY(0px) rotate(0deg); }
    50% { transform: translateY(-10px) rotate(5deg); }
}

.page-header-section::before {
    animation: a320-float 15s ease-in-out infinite;
}
.airbus-hero{
